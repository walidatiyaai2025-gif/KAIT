...
Require-Text 'docs/moj-api-reference/P08_AUTH_CONTRACT_MATRIX.md' 'DEFERRED_EXTERNAL' 'Unknown/external operation-level evidence is not explicitly deferred.'
Require-Text 'docs/evidence/P08_MOJ_AUTHENTICATION_INTEGRATION.md' '67968a9230dae453b36f48549eda138d7b5401c7' 'P08 exact integrated implementation baseline is not recorded.'
Require-Text 'docs/evidence/P08_MOJ_AUTHENTICATION_INTEGRATION.md' '17/17' 'P08 exact-main workflow evidence is not recorded.'

$evidence = (Get-Content 'docs/evidence/P08_MOJ_AUTHENTICATION_INTEGRATION.md' -Raw) + "`n" +
            (Get-Content 'docs/evidence/P08_CONTRACT_RECONCILIATION.md' -Raw)
