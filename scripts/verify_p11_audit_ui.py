...
checks = {
    ...
    "controller binds audit event filter to non-reserved query key": '[FromQuery(Name = "eventAction")] string? eventAction' in text["controller"],
    ...
    "view preserves audit action filter without reserved route collision": 'name="eventAction"' in text["view"] and 'asp-route-eventAction=' in text["view"] and 'asp-route-action=' not in text["view"],
