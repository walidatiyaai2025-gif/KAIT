...
P07 is the sole next legal implementation phase only after this final corrected P06 reconciliation is normally integrated to `main` and the resulting exact-main closed-phase regressions remain green. P08–P17 remain locked.
