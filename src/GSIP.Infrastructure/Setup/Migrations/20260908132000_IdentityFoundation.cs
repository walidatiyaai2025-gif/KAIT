...
[Migration("20260908132000_IdentityFoundation")]
public sealed class IdentityFoundation : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey("FK_AuthenticationAuditEvents_AspNetUsers_UserId", x => x.UserId, "AspNetUsers", "Id", onDelete: ReferentialAction.SetNull);
            });
        ...
        migrationBuilder.CreateIndex("IX_AuthenticationAuditEvents_OccurredAtUtc", "AuthenticationAuditEvents", "OccurredAtUtc");
        migrationBuilder.CreateIndex("IX_AuthenticationAuditEvents_UserId_OccurredAtUtc", "AuthenticationAuditEvents", new[] { "UserId", "OccurredAtUtc" });
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropTable(name: "AuthenticationAuditEvents");
        migrationBuilder.DropTable(name: "AspNetRoles");
        migrationBuilder.DropTable(name: "AspNetUsers");
        migrationBuilder.DropColumn(name: "ActivatedAtUtc", table: "BootstrapAdministrators");
    }
}
